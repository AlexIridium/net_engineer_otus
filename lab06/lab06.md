...
Скрин с настройками маршрутизатора :
...
a.	Настройка статического транкинга на интерфейсе F0/1 для обоих коммутаторов.Откройте окно конфигурации
...
a.	Активирован интерфейс G0/0/1 на маршрутизаторе.
...
![](https://github.com/AlexIridium/net_engineer_otus/blob/main/lab06/pic25.JPG)

![](https://github.com/AlexIridium/net_engineer_otus/blob/main/lab06/pic26.JPG)

![](https://github.com/AlexIridium/net_engineer_otus/blob/main/lab06/pic27.JPG)
...
![](https://github.com/AlexIridium/net_engineer_otus/blob/main/lab06/pic28.JPG)

b.	Отправьте эхо-запрос с PC-A на PC-B.

![](https://github.com/AlexIridium/net_engineer_otus/blob/main/lab06/pic29.JPG)

c.	Отправьте команду ping с компьютера PC-A на коммутатор S2.

![](https://github.com/AlexIridium/net_engineer_otus/blob/main/lab06/pic30.JPG)
...
В окне командной строки на PC-B выполнена команда *tracert* на адрес PC-A.

![](https://github.com/AlexIridium/net_engineer_otus/blob/main/lab06/pic31.JPG)
...
Отображаются следующие промежуточные адреса: 192.168.30.1 - адрес шлюза по умолчанию для РС-В и 192.168.20.3 - IP-адрес РС-А.
